...
===============================================================================
  ...
  Paso 2: Deteccion de bordes con algoritmo de Canny
===============================================================================

  Descripcion:
      Extiende el controlador base agregando la primera etapa de
      procesamiento de imagen: conversion a escala de grises, suavizado
      Gaussiano y deteccion de bordes con Canny.

  Pipeline:  Camara -> Grises -> Blur Gaussiano -> Canny -> Display

  Parametros de Canny:
      - Umbral bajo: 50 | Umbral alto: 150 | Kernel: 5x5
      - Nota: umbrales reducidos porque la imagen es pequena (128x64 px)
