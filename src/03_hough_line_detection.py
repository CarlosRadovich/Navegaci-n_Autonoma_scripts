...
===============================================================================
  ...
  Paso 3: Deteccion de lineas con transformada de Hough
===============================================================================

  Descripcion:
      Agrega ROI trapezoidal (fillPoly) y deteccion de segmentos de
      linea recta con HoughLinesP. Verifica la deteccion antes de
      integrar el controlador PID.

  Pipeline:  Camara -> Grises -> Blur -> Canny -> ROI -> HoughLinesP -> Display

  Parametros de Hough:
      rho=1 | theta=pi/180 | threshold=25 | minLen=20 | maxGap=30
