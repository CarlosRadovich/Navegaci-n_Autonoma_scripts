...
===============================================================================
  ...
  Paso 4: Controlador PID para seguimiento de carril (10 km/h)
===============================================================================

  Descripcion:
      Integra el pipeline completo de vision con un controlador PID
      que ajusta automaticamente la direccion para seguir el carril.
      El angulo se suaviza para evitar oscilaciones.

  Pipeline:  Camara -> Grises -> Canny -> ROI -> Hough -> Error -> PID -> Vehiculo

  Ganancias PID:  Kp=0.001 | Ki=0.0 | Kd=0.0  (proporcional puro)
  Velocidad: 10 km/h
