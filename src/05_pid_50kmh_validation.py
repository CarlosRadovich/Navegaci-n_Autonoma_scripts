...
===============================================================================
  ...
  Paso 5: Validacion del controlador PID a 50 km/h
===============================================================================

  Descripcion:
      Prueba final a la velocidad minima requerida (50 km/h).
      Ganancias PID mas conservadoras (Kp=0.0007) y cambio maximo
      de direccion reducido (0.025 rad/paso) para compensar la
      mayor velocidad.

  Pipeline:  Camara -> Grises -> Canny -> ROI -> Hough -> Error -> PID -> Vehiculo

  Ganancias PID:  Kp=0.0007 | Ki=0.0 | Kd=0.0
  Velocidad: 50 km/h
