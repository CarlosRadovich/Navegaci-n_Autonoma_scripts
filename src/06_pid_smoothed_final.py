...
===============================================================================
  ...
  Paso 6: Controlador PID con suavizado exponencial (version final)
===============================================================================

  Descripcion:
      Version final del sistema de seguimiento de carril. Incorpora:
        - Suavizado exponencial del error (EMA: 60/40)
        - Ganancia derivativa activa (Kd=0.015)
        - Racha de "sin linea" para perdidas temporales de deteccion
        - Saturacion del termino integral (anti wind-up)

  Pipeline:  Camara -> Grises -> Canny -> ROI -> Hough -> Error -> EMA -> PID -> Vehiculo

  Ganancias PID:  Kp=0.008 | Ki=0.0 | Kd=0.015
  Suavizado:  error = 0.6 * anterior + 0.4 * nuevo
  Velocidad: 50 km/h
